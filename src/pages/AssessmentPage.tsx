...
export default function AssessmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 via-slate-50 to-emerald-50/40">
      <Header />
      <main className="max-w-3xl mx-auto px-6 py-10">
        ...
        <footer className="text-center text-sm text-slate-500 mt-8 pb-10 space-y-2">
